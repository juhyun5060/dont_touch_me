...
function create() {
  ...
  this.backgrouund = this.game.add.sprite(0,0,'back2'); // 게임 배경 설정 
  ...
  enemy1.createMultiple(7, "enemy1"); //적 개수
  ...
  txtLocation = game.add.text(10, 15, "STAGE 2 버스 -> 지하철", { fontSize: "20px Arial", fill: "#FFFFFF" });
